...
def train():
    ...
    env = make_atari_env(game_name, n_envs=n_envs, seed=seed, wrapper_kwargs=rule_based_kwargs)
    ...
    model.learn(total_timesteps=config["training"]["num_episodes"], tb_log_name=model_name+"_breakout_rb")
